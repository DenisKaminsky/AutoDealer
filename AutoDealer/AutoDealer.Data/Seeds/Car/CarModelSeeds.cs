    ...
    public static class CarModelSeeds
    {
        public static void SeedCarModels(this ModelBuilder modelBuilder)
        {
            var carModels = new[]
            {
               ...
               new CarModel { Id = 18, Name = "S63 AMG", BrandId = 8, Price = 153000 },
               new CarModel { Id = 19, Name = "GLS 450", BrandId = 8, Price = 99700 },
               new CarModel { Id = 20, Name = "SLS AMG GT", BrandId = 8, Price = 385000 },
