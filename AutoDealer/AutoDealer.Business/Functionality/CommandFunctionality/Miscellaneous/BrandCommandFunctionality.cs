...
{
    public class BrandCommandFunctionality : BaseGenericCreateUpdateDeleteCommandFunctionality<BrandCreateCommand, BrandUpdateCommand, Brand>, IBrandCommandFunctionality
    {
